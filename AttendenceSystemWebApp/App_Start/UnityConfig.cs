...
namespace AttendenceSystemWebApp
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRepository<AttndRegDet>, SqlRepository<AttndRegDet>>();
            container.RegisterType<IRepository<Dept>, SqlRepository<Dept>>();
            container.RegisterType<IRepository<Designation>, SqlRepository<Designation>>();
            container.RegisterType<IRepository<Entity>, SqlRepository<Entity>>();
            //container.RegisterType<IRepository<AspNetUser>, SqlRepository<AspNetUser>>();
        }
    }
}